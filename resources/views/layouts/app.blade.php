...
<head>
  ...
  <!-- Clarity tracking code for https://lyndakade.ir/ --><script>    (function(c,l,a,r,i,t,y){        c[a]=c[a]||function(){(c[a].q=c[a].q||[]).push(arguments)};        t=l.createElement(r);t.async=1;t.src="https://www.clarity.ms/tag/"+i+"?ref=bwt";        y=l.getElementsByTagName(r)[0];y.parentNode.insertBefore(t,y);    })(window, document, "clarity", "script", "97tl9nt3cb");</script><!-- Clarity tracking code for https://lyndakade.ir/ --><script>    (function(c,l,a,r,i,t,y){        c[a]=c[a]||function(){(c[a].q=c[a].q||[]).push(arguments)};        t=l.createElement(r);t.async=1;t.src="https://www.clarity.ms/tag/"+i+"?ref=bwt";        y=l.getElementsByTagName(r)[0];y.parentNode.insertBefore(t,y);    })(window, document, "clarity", "script", "97tl9nt3cb");</script>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark w-100 py-0">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link px-md-1" href="{{ route('faq') }}" style="background-color: darkcyan;">سوالات متداول</a>
          </li>
          <li class="nav-item">
