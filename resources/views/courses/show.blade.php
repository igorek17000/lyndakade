...
@section('content')
  ...
  <style>
    .short-link {
      ...
      left: 0;
      top: 2px;
      background: url(data:image/svg+xml;charset=UTF-8,<svg class="svg-inline--fa fa-clone fa-w-16" aria-hidden="true" data-prefix="fa" data-icon="clone" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M464 0c26.51 0 48 21.49 48 48v288c0 26.51-21.49 48-48 48H176c-26.51 0-48-21.49-48-48V48c0-26.51 21.49-48 48-48h288M176 416c-44.112 0-80-35.888-80-80V128H48c-26.51 0-48 21.49-48 48v288c0 26.51 21.49 48 48 48h288c26.51 0 48-21.49 48-48v-48H176z"></path></svg>) no-repeat;
