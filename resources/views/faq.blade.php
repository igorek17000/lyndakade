...
$questions = [
    [
        ...
        1) خرید دوره با پرداخت مستقیم: در این روش، دوره(‌های) مورد نظر خود را به <a target="_blank" href="' .
            ...
            '">تماس با ما </a> به ما اطلاع رسانی کنید تا توسط تیم پشتیبانی بررسی شود.
    ...
    [
        ...
        'answer' =>
            'در صورتی که با استفاده از روش جستجو، قادر به یافتن دوره آموزشی مورد نظر نبوده‌اید، می‌توانید پس از ورود به حساب کاربری، به صفحه <a target="_blank" href="' .
