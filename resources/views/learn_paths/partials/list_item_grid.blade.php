  ...
  <div class="card">
    <a class="card-content" href="{{ route('learn.paths.show', [$path->slug]) }}">
      ...
      <div class="card-img-overlay text-center">
        ...
        <h5 class="titlePer" style="height: 42px !important; font-size: initial;">{{ $path->title }}</h5>
        <h5 class="titleEng" style="height: 42px !important; font-size: initial;">{{ $path->titleEng }}</h5>
        <div style="font-size: .8rem; font-weight: 400;">
          ...
          @if ($path->durationMinutes() > 0)
            ...
            دقیقه
          @endif
          <p class="mb-2 mt-2">تعداد دروس {{ nPersian(count(js_to_courses($path->courses))) }}</p>
          <del
