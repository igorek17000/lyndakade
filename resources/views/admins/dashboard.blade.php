@extends('layouts.admin', ['pageSlug' => 'admins.dashboard'])
                ...
                <div class="card-header">
                    <div class="row" id="chart-total-view">
                        <div class="col-sm-12 col-md-6">
                            <h5 class="card-category">Views</h5>
                            <h3 class="card-title"><i class="tim-icons icon-money-coins text-primary"></i>
                                Total Views in Last Month: <span class="float-right"
                                                                 id="charBig1TotalViewLastMonth"></span></h3>
                            <h3 class="card-title"><i class="tim-icons icon-money-coins text-primary"></i>
                    ...
                    <div class="row" id="chart-total-purchase" style="display:none;">
                        <div class="col-sm-12 col-md-6">
                            <h5 class="card-category">Counts</h5>
                            <h3 class="card-title"><i class="tim-icons icon-money-coins text-primary"></i> Total Last
                                Month: <span class="float-right" id="charBig1TotalCountLastMonth"></span></h3>
                            <h3 class="card-title"><i class="tim-icons icon-money-coins text-primary"></i> Total All
                                Time: <span class="float-right" id="charBig1TotalCountAllTime"></span></h3>
                        </div>
                        <div class="col-sm-12 col-md-6">
                            <h5 class="card-category">Prices</h5>
                            <h3 class="card-title"><i class="tim-icons icon-money-coins text-primary"></i> Total Last
                                Month:
                                <span class="float-right" id="charBig1TotalPriceLastMonth"></span></h3>
                            <h3 class="card-title"><i class="tim-icons icon-money-coins text-primary"></i> Total All
                                Time:
                                <span class="float-right" id="charBig1TotalPriceAllTime"></span></h3>
                        </div>
                    </div>
                </div>
            </div>
