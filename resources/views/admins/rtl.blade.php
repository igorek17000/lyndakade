      ...
      -->
        <div class="sidebar-wrapper">
            ...
            <ul class="nav">
                ...
                <li>
                    <a href="{{ route('admins.icons') }}">
                        <i class="tim-icons icon-atom"></i>
                        <p>الرموز</p>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admins.maps') }}">
                        <i class="tim-icons icon-pin"></i>
                        <p>خرائط</p>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admins.notifications') }}">
                ...
                <li>
                    <a href="{{ route('admins.tables') }}">
                        <i class="tim-icons icon-puzzle-10"></i>
                        <p>قائمة الجدول</p>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admins.typography') }}">
                        <i class="tim-icons icon-align-center"></i>
                        <p>طباعة</p>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admins.rtl') }}">
                        <i class="tim-icons icon-world"></i>
                        <p>دعم RTL</p>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admins.upgrade') }}">
...
<!-- Control Center for Black Dashboard: parallax effects, scripts for the example admins etc -->
