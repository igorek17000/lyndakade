...
function get_seo_keywords()
{
    ...
    $text = implode(" , ", [
        ...
        "بهترین سایت های آموزش مجازی رایگان",
        "دانلود آموزش های لینکدین رایگان",
        "دانلود آموزش های لیندا رایگان",
        "دانلود آموزش های لینکدین دوبله فارسی",
        "دانلود آموزش های لیندا دوبله فارسی",
        "دانلود آموزش های لیندا",
        "دانلود آموزش های لینکدین",
        ...
        "مدرک لیندکین",
        "پکیچ آموزش لینکدین",
        "آموزش آنلاین لینکدین",
        "آموزش لینکدین حرفه ای",
        "ربات تلگرام دانلود از لینکدین",
        "سایت آموزشی لیندا",
        "آموزش دانلود از لیندا",
        "آموزش های udemy با زیرنویس فارسی",
        "فارسی لیندا",
        "کد تخفیف فارسی لیندا",
        "آموزش های لیندا با زیرنویس فارسی رایگان",
        "دانلود زیرنویس آموزش های لیندا",
    ]);
    return $text;
}
